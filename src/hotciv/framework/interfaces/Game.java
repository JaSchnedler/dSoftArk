...
public interface Game {
  ...
  public void performUnitActionAt( Position p );
    ...
    /***
     * Ends the turn X number of times.
     */
    void endRoundNumberOfTimes(int times);

    /***
     * Gets the cities of the game.
     * @return
     */
    public HashMap<Position, City> getCities();

    /***
     * Gets the units of the game.
     * @return
     */
    ...
    /***
     * Gets the tiles of the game world.
     * @return
     */
    public HashMap<Position, Tile> getTiles();

    UnitStateStrategy getUnitStateStrategy();

    UnitConstantsStrategy getUnitConstants();
}
